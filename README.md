...
## GRUNT
Foi feita a inclusão do Grunt para rodar o LESS (watch), o comando para atualização do main.less seria o "grunt watch", ele já gera a build do css minificado. 